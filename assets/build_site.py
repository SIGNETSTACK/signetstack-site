...
MODULE_ORDER = ["core", "vault", "ai-governance", "lake", "stream", "clean-room", "embedded", "data-trust-network", "pades"]
MODULES = {
 ...
 "pades": {"name": "Signet PAdES Enterprise", "icon": "pades", "kicker": "Post-Quantum Document Signing",
   "tagline": "Long-term, quantum-resistant PDF signatures.",
   "overview": "Signet PAdES Enterprise brings post-quantum digital signatures to PDFs at the ETSI EN 319 142-1 standard — PAdES B-B / B-T / B-LT / B-LTA profiles, ML-DSA-65 signing, timestamp-authority and HSM/KMS adapters, and long-term archival validation.",
   "caps": [("ETSI PAdES profiles","B-B, B-T, B-LT and B-LTA for long-term validity."),
            ("Post-quantum signing","ML-DSA-65 signatures alongside classical primitives."),
            ("TSA & HSM/KMS adapters","Trusted timestamps and hardware-backed keys."),
            ("Long-term archive","Signatures that stay verifiable for decades.")],
   "tags": ["ETSI EN 319 142-1","PAdES B-LTA","ML-DSA-65"], "status": "Crypto core complete; enterprise / SaaS tiers on the roadmap."},
}
...
ICONS = {
 ...
 "pades": '<path d="M7 3 h7 l4 4 v14 H7 z"/><path d="M14 3 v4 h4"/><path d="M9.4 14.4 l1.9 1.9 l3.5-3.7"/>',
